...
class SD():
    def __init__(self, SPIselect, SD_CS, sdfolder):
        ...
        try:
            print(1)
#            spi = machine.SPI(1, 100000, 0, 0, 8, machine.SPI.MSB, Pin(14), Pin(12), Pin(15))
            print(2)
#            self.sd = sdcard.SDCard(SPI(1), Pin(13))
            print(3)
            print(spi)
            self.sd = sdcard.SDCard(spi, Pin(SD_CS))
...
if __name__ == "__main__":
    ...
    sdfolder = "/sd"
    SPIselect = 1                  # 0/1 for SPI0 or SPI1
    SD_CS = 13                      # Chip select for SD  (may be any GP pin)
